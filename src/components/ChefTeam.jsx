...
const chefs = [
  {
    ...
    image: "/images/sefler/yalcin.jpg",  // public klasörü altındaki resim yolu
  ...
  {
    name: "Frontend Developer Ilgın Habibe Yürekçi",
    image: "/images/sefler/ilgin.jpg",
    bio: "Gusto Damak Tadında 2024'ten beri Frontend Developer olarak görev yapmaktadır.",
    since: 2024,
    stars: 4,
    socials: {
    ...
    reviews: [
      ...
      { user: "Asiye", comment: "Profesyonel olma yolunda" }
    ]
  },
  {
    name: "Müdürümüz Veysel Guguk",
    image: "/images/sefler/veysel.png",
    bio: "Açıldığı yıldan beri Gusto Damak Tadı'nda müdürlük yapıyor.",
    since: 2022,
    stars: 5,
    socials: {
  ...
  {
    name: "Şef Eyüp Güner",
    image: "/images/sefler/eyup.png",
    bio: "Açıldığı yıldan beri Gusto Damak Tadı'nda şeflik yapıyor.",
    since: 2022,
    stars: 4,
    socials: {
  ...
  },
  {
    ...
    image: "/images/sefler/ferdi.png",
    bio: "Açıldığı yıldan beri Gusto Damak Tadı'nda pasta ustalığı yapıyor.",
    since: 2022,
    stars: 3,
    socials: {
  ...
  },
  {
    ...
    image: "/images/sefler/adem.png",
    bio: "Açıldığı yıldan beri Gusto Damak Tadı'nda ekmek ustalığı yapıyor.",
    since: 2022,
    stars: 3,
    socials: {
